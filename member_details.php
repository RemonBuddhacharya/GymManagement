        ...
        <div class="modal-body">
            ...
            <input type="hidden" name="update_id" id="update_id">
                <div class="mb-3">
                    ...
                    <input class="form-control" type="text" id="firstname" placeholder="First Name" aria-label="default input example" name="firstname">
                </div>
                <div class="mb-3">
                    <label for="lastname" class="form-label">Last Name</label>
                    <input class="form-control" type="text" id="lastname" placeholder="Last Name" aria-label="default input example" name="lastname">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="trainer" aria-describedby="emailHelp" name="trainer">
                </div>
        </div>
